...
def main():
    ...
    required=['R2_ACCESS_KEY_ID','R2_SECRET_ACCESS_KEY','R2_ENDPOINT','R2_BUCKET','R2_PUBLIC_URL']; missing=[v for v in required if not os.environ.get(v)]
    ...
    enclosure=f'{public}/{key}'; upsert_episode(a.feed,enclosure,size,a.slug,a.title,a.description,a.duration); print(enclosure)
